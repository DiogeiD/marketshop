<x-layout_base>
    <div class="flex flex-col items-center justify-center min-h-screen bg-yellow-400">
<div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm bg-neutral-900 dark:border-neutral-700">
      ...
      <form action="{{route('logar')}}" method="POST">
        ...
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <p class="hidden text-xs text-red-600 mt-2" id="email-error">endereço para que possamos entrar em contato com você </p>
          </div>
          <!-- End Form Group -->
